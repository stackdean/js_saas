  ...
  >
    ...
    <main class="chief" role="none">
      <div class="wrap">
        <div class="page">
          <div class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                ...
                >
                  <img
                    src="{{ asset('public/site/assets/addmember.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
              ...
              <div class="logout">
                <a
                  class="button button-small button-icon-flip button-nocolor button-transparent"
                  href="https://dashboard.accessibe.com/logout"
                  ><i
                    class="icon icon-off"
                    aria-hidden="true"
                    role="presentation"
                    ...
                    >
                      ...
                      ></path>
                      <path
                        d="M7.5,9L2.3,3.7L0,6V0h6L3.7,2.3L9,7.5L7.5,9z"
                      ></path></svg
                  ></i>
          ...
          <div class="section">
            <div class="inner">
              ...
              <form
                class="account-name-form flex flex-horizontal-start"
                data-form="accounts/update-info"
                method="POST"
                action="#"
                enctype="multipart/form-data"
              >
                <div class="field">
                  <label for="accountName"
                    >Account name (typically the company’s name)</label
                  >
          ...
          <div class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                <div class="heading flex flex-inline flex-horizontal-start">
                  <img
                    src="{{ asset('public/site/assets/apikey.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
          ...
          <div class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                <div class="heading flex flex-inline flex-horizontal-start">
                  <img
                    src="{{ asset('public/site/assets/email.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
              ...
              <form
                class="top-cta notifications-form"
                data-form="accounts/update-info"
                method="POST"
                action="#"
                enctype="multipart/form-data"
              >
                <div class="fields flex flex-horizontal-start">
                  <fieldset>
                    ...
                    <div class="box">
                      <input
                        id="statementsSelfNotify1"
                        type="radio"
                        value="1"
                        name="statementsSelfNotify"
                        checked=""
                        tabindex="0"
                      /><label for="statementsSelfNotify1">
                        My account members and myself
                      </label>
                    </div>
                    <div class="box">
                      <input
                        id="statementsSelfNotify0"
                        type="radio"
                        value="0"
                        name="statementsSelfNotify"
                        tabindex="0"
                      /><label for="statementsSelfNotify0">
                  ...
                  <fieldset>
                    ...
                    <div class="box">
                      <input
                        id="auditsSelfNotify1"
                        type="radio"
                        value="1"
                        name="auditsSelfNotify"
                        checked=""
                        tabindex="0"
                      /><label for="auditsSelfNotify1">
                        My account members and myself
                      </label>
                    </div>
                    <div class="box">
                      <input
                        id="auditsSelfNotify0"
                        type="radio"
                        value="0"
                        name="auditsSelfNotify"
                        tabindex="0"
                      /><label for="auditsSelfNotify0">
                        My website's contact emails
                      </label>
                    </div>
                  </fieldset>
          ...
          <div class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                <div class="heading flex flex-inline flex-horizontal-start">
                  <img
                    src="{{ asset('public/site/assets/userinfo.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
              ...
              <form
                class="top-cta user-form"
                action="#"
                data-form="users/update-info"
                method="POST"
                enctype="multipart/form-data"
              >
        ...
        <div
          class="popup popup-add-member popup-xsmall js-ready"
          data-clicker-element="popup-add-member"
          data-clicker-lock-body="true"
        >
          <div
            class="wide-close js-a11y-bound"
            data-clicker-close="popup-add-member"
            role="button"
            aria-hidden="true"
          ></div>
          <div class="content">
            ...
            <form
              data-form="members/send-invitation"
              action="#"
              method="post"
              enctype="multipart/form-data"
            >
              ...
              <div class="fields">
                <div class="field">
                  <label for="memberName">
                    Team member name <span class="req">*</span></label
                  ><input
                    id="memberName"
                    name="memberName"
                    aria-required="true"
                ...
                <div class="field">
                  <label for="memberEmail">
                    Team member email <span class="req">*</span></label
                  ><input
                    id="memberEmail"
                    name="memberEmail"
                    aria-required="true"
                ...
                <div class="field">
                  <label for="memberRole">
                    Team member role <span class="req">*</span></label
                  ><select
                    name="memberRole"
                    id="memberRole"
                    aria-required="true"
        ...
        <div
          class="popup popup-add-member popup-xsmall js-ready"
          data-clicker-element="popup-add-account"
          data-clicker-lock-body="true"
        >
          <div
            class="wide-close js-a11y-bound"
            data-clicker-close="popup-add-account"
            role="button"
            aria-hidden="true"
          ></div>
          <div class="content">
    ...
    >
      ...
      <div
        class="acsb-popup acsb-hide-popup"
        tabindex="0"
        data-acsb-popup="acsb-hide-popup"
      >
        <div
          class="acsb-popup-close-wide"
