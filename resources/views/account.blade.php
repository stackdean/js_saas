...
<head>
    ...
    <title>@yield('title', __('Account')) | {{ Utility::getsettings('app_name') }}</title>
...
<body class="theme-account" data-new-gr-c-s-check-loaded="14.1064.0" data-gr-ext-installed="">
            ...
            <div class="wrap flex flex-reverse flex-nowrap">
                ...
                >
                  accessServices
                    ...
                    <ul>
                        <li>
                            <a class="active" href="{{url('account')}}"> Account &amp; Team </a>
                        </li>
                        <li>
            ...
            <div class="inner">
                <div class="start">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" data-form="process-form-submission">
                        ...
                        <input type="hidden" name="pageURL" value="/account" aria-hidden="true" /><input type="hidden"
                            name="element" value="demo-form" aria-hidden="true" />
                    </form>
    ...
    <main class="chief" role="none">
        <div class="wrap">
            <div class="page">
                    ...
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start" role="main"
                                ...
                                <img src="{{ asset('public/site/assets/addmember.svg')}}" alt="Icon"
                                    role="presentation" />
                                <h2 class="title title-medium2">Your account memberships</h2>
                            </div>
                            <div class="buttons flex flex-inline flex-horizontal-end">
                                <div class="cta">
                                    <a class="button button-small button-transparent js-a11y-bound"
                                        href="#popup-add-account" role="button">
                                        Add New Account
                                        <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                            <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <table class="js-a11y-bound">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><span class="semibold">whatshungry</span></td>
                                    <td><span class="ribbon">OWNER</span></td>
                                    <td><span class="ribbon">ACTIVE</span></td>
                                    <td>May 26, 2022</td>
                                    <td>
                                        <div class="semibold">This is currently active</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="logout">
                            <a class="button button-small button-icon-flip button-nocolor button-transparent"
                                href="https://dashboard.accessibe.com/logout"><i class="icon icon-off"
                                    aria-hidden="true" role="presentation"><svg version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 16 16"
                                        style="enable-background: new 0 0 16 16" xml:space="preserve">
                                        <path
                                            d="M8,0c4.4,0,8,3.6,8,8s-3.6,8-8,8s-8-3.6-8-8h2c0,3.3,2.7,6,6,6s6-2.7,6-6s-2.7-6-6-6V0z">
                                        </path>
                                        <path d="M7.5,9L2.3,3.7L0,6V0h6L3.7,2.3L9,7.5L7.5,9z"></path>
                                    </svg></i>
                    ...
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                <img src="{{ asset('public/site/assets/team.svg')}}" alt="Icon" role="presentation" />
                                <h2 class="title title-medium2">Team members</h2>
                            </div>
                            <div class="buttons flex flex-inline flex-horizontal-end">
                                <div class="cta">
                                    <a class="button button-small button-transparent js-a11y-bound"
                                        href="#popup-add-member" role="button">
                                        Add Team Member
                                        <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                            <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <table class="js-a11y-bound">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><span class="semibold">muz moh</span></td>
                                    <td>muzakkir332@gmail.com</td>
                                    <td>+44 7932776776</td>
                                    <td><span class="ribbon">OWNER</span></td>
                                    <td><span class="ribbon">ACTIVE</span></td>
                                </tr>
                        ...
                        <p class="text section-text">
                            Team members with an ‘Admin’ role have access to manage all
                            actions. Team members with a ‘User’ role can manage everything
                            except for billing information, user roles, and making payments.
                        </p>
                        <form class="account-name-form flex flex-horizontal-start" data-form="accounts/update-info"
                            method="POST" action="#" enctype="multipart/form-data">
                            <div class="field">
                                <label for="accountName">Account name (typically the company’s name)</label>
                                <div class="button-appended button-appended-medium">
                                    <input name="accountName" id="accountName" value="whatshungry"
                                        tabindex="0" /><button type="submit" class="button">SAVE</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="section">
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                <img src="{{ asset('public/site/assets/apikey.svg')}}" alt="Icon" role="presentation" />
                                <h2 class="title title-medium2">Subscriptions API Access</h2>
                            </div>
                            <div class="buttons flex flex-inline flex-horizontal-end">
                                <div class="cta">
                                    <a class="button button-small button-transparent js-a11y-bound"
                                        href="https://accessibe.com/support/installation/how-can-i-add-and-manage-subscriptions-using-api-or-csv-files"
                                        target="_blank" data-a11y-tooltip="New Window">
                                        API Documentation
                                        <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                            <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <ul class="api-keys">
                            <li>
                                This account does not have API access yet. Please contact us
                                if you need it.
                            </li>
                        </ul>
                        <p class="text section-text">
                            The Subscriptions API is built for customers and partners that
                            manage dozens or more websites, and need to automate
                            Subscription management. The API allows users to add or disable
                            subscriptions, upgrade or downgrade licenses, and manage
                            contacts and users programmatically.
                        </p>
                    </div>
                </div>
                <div class="section">
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                <img src="{{ asset('public/site/assets/email.svg')}}" alt="Icon" role="presentation" />
                                <h2 class="title title-medium2">Email notifications</h2>
                            </div>
                        </div>
                        <p class="text section-text">
                            Please designate who should be receiving system emails. If you
                            manage websites for other businesses, you can choose emails to
                            be sent directly to the website owner.
                        </p>
                        <form class="top-cta notifications-form" data-form="accounts/update-info" method="POST"
                            action="#" enctype="multipart/form-data">
                            <div class="fields flex flex-horizontal-start">
                                <fieldset>
                                    <legend>
                                        Who should we send accessibility statements to?
                                    </legend>
                                    <div class="box">
                                        <input id="statementsSelfNotify1" type="radio" value="1"
                                            name="statementsSelfNotify" checked="" tabindex="0" /><label
                                            for="statementsSelfNotify1">
                                            My account members and myself
                                        </label>
                                    </div>
                                    <div class="box">
                                        <input id="statementsSelfNotify0" type="radio" value="0"
                                            name="statementsSelfNotify" tabindex="0" /><label
                                            for="statementsSelfNotify0">
                                            My website's contact emails
                                        </label>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <legend>Who should we send compliance audits to?</legend>
                                    <div class="box">
                                        <input id="auditsSelfNotify1" type="radio" value="1" name="auditsSelfNotify"
                                            checked="" tabindex="0" /><label for="auditsSelfNotify1">
                                            My account members and myself
                                        </label>
                                    </div>
                                    <div class="box">
                                        <input id="auditsSelfNotify0" type="radio" value="0" name="auditsSelfNotify"
                                            tabindex="0" /><label for="auditsSelfNotify0">
                                            My website's contact emails
                                        </label>
                                    </div>
                                </fieldset>
                ...
                <div class="section">
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                <img src="{{ asset('public/site/assets/userinfo.svg')}}" alt="Icon"
                                    role="presentation" />
                                <h2 class="title title-medium2">Update user information</h2>
                            </div>
                        </div>
                        <form class="top-cta user-form" action="#" data-form="users/update-info" method="POST"
                            enctype="multipart/form-data">
                            <div class="fields flex flex-vertical-start">
                                <div class="field field-line">
                                    <label for="name">Name</label><input type="text" name="name" id="name"
                                        value="muz moh" tabindex="0" style="
                      ...
                      " />
                                ...
                                <div class="field field-line">
                                    <label for="email">Email</label><input type="text" name="email" id="email"
                                        value="muzakkir332@gmail.com" tabindex="0" />
                                </div>
                                <div class="field field-line field-phone">
                                    <label for="phone">Phone number</label>
                                    <div class="input">
                                        <select name="country" aria-label="country" tabindex="0">
                                        ...
                                        </select><input id="phone" name="phone" value="7932776776" type="text"
                                            tabindex="0" />
                                    </div>
                                </div>
                                <div class="field field-line">
                                    <label for="password">Password</label><input type="password" name="password"
                                        id="password" autocomplete="new-password" tabindex="0" style="
                      ...
                      " />
                            ...
                            <div class="checkbox">
                                <input type="checkbox" id="subscribed" value="1" name="subscribed" checked=""
                                    tabindex="0" /><label for="subscribed">
            ...
            <div class="popup popup-add-member popup-xsmall js-ready" data-clicker-element="popup-add-member"
                data-clicker-lock-body="true">
                <div class="wide-close js-a11y-bound" data-clicker-close="popup-add-member" role="button"
                    aria-hidden="true"></div>
                <div class="content">
                    <div class="close js-a11y-bound" role="button" aria-label="Close"
                        data-clicker-close="popup-add-member" aria-hidden="true">
                        <span class="sr-only">Close</span><i class="icon icon-close" aria-hidden="true"
                            role="presentation"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16">
                                <path
                    ...
                    <form data-form="members/send-invitation" action="#" method="post" enctype="multipart/form-data">
                        <div class="popup-heading">
                            <div class="title title-medium">
                                Fill out a new team member’s info and we’ll invite them to
                                your account!
                            </div>
                        </div>
                        <div class="fields">
                            <div class="field">
                                <label for="memberName">
                                    Team member name <span class="req">*</span></label><input id="memberName"
                                    name="memberName" aria-required="true" aria-hidden="true" />
                            </div>
                            <div class="field">
                                <label for="memberEmail">
                                    Team member email <span class="req">*</span></label><input id="memberEmail"
                                    name="memberEmail" aria-required="true" aria-hidden="true" />
                            </div>
                            <div class="field">
                                <label for="memberRole">
                                    Team member role <span class="req">*</span></label><select name="memberRole"
                                    id="memberRole" aria-required="true" aria-hidden="true">
            ...
            <div class="popup popup-add-member popup-xsmall js-ready" data-clicker-element="popup-add-account"
                data-clicker-lock-body="true">
                <div class="wide-close js-a11y-bound" data-clicker-close="popup-add-account" role="button"
                    aria-hidden="true"></div>
                <div class="content">
                    <div class="close js-a11y-bound" role="button" aria-label="Close"
                        data-clicker-close="popup-add-account" aria-hidden="true">
                        <span class="sr-only">Close</span><i class="icon icon-close" aria-hidden="true"
                            role="presentation"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16">
                                <path
                    ...
                    <form data-form="accounts/add-new" action="#" method="post" enctype="multipart/form-data">
                        <div class="popup-heading">
                            <div class="title title-medium">Add a new account</div>
                        </div>
                        <div class="fields">
                            <div class="field">
                                <label for="newAccountName">
                                    Account name (typically the company’s name)
                                    <span class="req">*</span></label><input id="newAccountName" name="newAccountName"
    ...
    <style type="text/css" class="acsb-dynamic-colors">
        ...
        z-index: -1 !important;
        pointer-events: none;
      " tabindex="0" title="Intercom" src="{{ asset('public/site/assets/saved_resource(1).html')}}"></iframe>
</body>
