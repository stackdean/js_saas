...
<head>
    ...
    <meta name="description" content="accessFlow" />
    <link href="https://dashboard.accessibe.com/media/template/favicon.ico" type="image/x-icon" rel="shortcut icon" />
    <title>@yield('title', __('ًAccess Flow')) | {{ Utility::getsettings('app_name') }}</title>
...
<body class="theme-accessflow" data-new-gr-c-s-check-loaded="14.1064.0" data-gr-ext-installed="">
    <div class="a11y-skip-links js-a11y-bound" aria-label="Skip links" role="region">
        <a class="a11y-skip-link js-a11y-bound" href="accessflow.html#a11y-landmark-content"
            data-a11y-skip-link="content">Skip to content<span aria-hidden="true"></span></a><a
            class="a11y-skip-link js-a11y-bound" href="accessflow.html#a11y-landmark-menu"
            data-a11y-skip-link="menu">Skip to menu<span aria-hidden="true"></span></a><a
            class="a11y-skip-link js-a11y-bound" href="accessflow.html#a11y-landmark-footer"
            data-a11y-skip-link="footer">Skip to footer<span aria-hidden="true"></span></a>
    </div>
                ...
                <div class="start flex flex-inline flex-nowrap">
                    ...
                    <nav class="menu js-a11y-bound" aria-label="Main menu" data-a11y-landmark="menu"
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="active" href="{{url('flow')}}"><i class="icon icon-access-flow" aria-hidden="true"
            ...
            <div class="wrap flex flex-reverse flex-nowrap">
                ...
                <nav class="menu flex flex-nowrap js-a11y-bound" aria-label="Main menu" data-a11y-landmark="menu"
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="active" href="{{url('flow')}}" aria-hidden="true" tabindex="-1">
                                accessFlow
                            </a>
                        </li>
                        {{-- <li>
        ...
        <div class="content">
            <div class="inner">
                <div class="start">
                    ...
                    <form action="accessflow.html#" method="POST" enctype="multipart/form-data"
                        ...
                        <input type="hidden" name="pageURL" value="/accessflow" aria-hidden="true" /><input
                ...
                <div class="hero flex">
                    <div class="start" role="main" data-a11y-landmark="content" id="a11y-landmark-content">
                        <h1 class="title title-big">
                            <span class="mark">All-In-One</span>  Web Accessibility
                            <span class="mark">Platform</span>  for Developers
                        </h1>
                        <p class="text">
                            The A-Z platform for accessibility projects, testing,
                            monitoring, and remediation for websites and apps.
                        </p>
                        <a class="text-button js-a11y-bound" href="https://accessibe.com/accessflow" target="_blank"
                            data-a11y-tooltip="New Window">
                            More about accessFlow
                            <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" viewBox="0 0 9.5 16" style="enable-background: new 0 0 9.5 16"
                    ...
                    <div class="end">
                        <img class="object-cover" src="./assets/flow-hero.png" alt="illustration" role="presentation" />
                    </div>
                </div>
                <div class="page">
                    <div class="section">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                ...
                                <h2 class="title title-medium">accessFlow Licenses</h2>
                            </div>
                            <div class="buttons flex flex-inline flex-horizontal-end">
                                <div class="cta">
                                    <a class="button button-small button-icon-flip button-transparent js-a11y-bound"
                                        href="accessflow.html#" data-manage-accessflow=""
                                        data-clicker-trigger="managebar" role="button"><i class="icon icon-plus"
                                            aria-hidden="true" role="presentation"><svg version="1.1"
                                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                viewBox="0 0 12.3 12.3" style="enable-background: new 0 0 12.3 12.3"
                                                xml:space="preserve">
                                                <path d="M12.3,5.1v2.1H7.2v5.1H5.1V7.2H0V5.1h5.1V0h2.2v5.1H12.3z">
                                                </path>
                                            </svg></i>
                                        Add New License
                                    </a>
                        ...
                        <table class="licenses-table no-management no-licenses js-a11y-bound" data-accessflow-table="">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Domain</th>
                        ...
                        <div class="no-websites-content">
                            <p class="text">
                                Once you’ve added your website(s), you’ll be able to launch
                                accessFlow and manage your licenses from here.
                            </p>
                            <img src="./assets/no-flow-licenses.svg" alt="Website Illustration" role="presentation" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="popup popup-contact popup-xsmall js-ready" data-clicker-element="popup-contact"
        ...
        <div class="content">
            ...
            <form action="accessflow.html#" method="POST" enctype="multipart/form-data"
                ...
                <input type="hidden" name="pageURL" value="/accessflow" aria-hidden="true" /><input type="hidden"
        ...
        <div class="acsb-main" data-acsb="main">
            <div class="acsb-header acsb-flex">
                <div class="acsb-start">
                    <a href="accessflow.html#" role="button" tabindex="0"
                ...
                <a role="button" href="accessflow.html#" tabindex="0" aria-label="English"
            ...
            <div class="acsb-hero">
                ...
                <div class="acsb-hero-actions acsb-flex">
                    <a href="accessflow.html#" class="acsb-hero-action" role="button" tabindex="0"
                        data-acsb-option="reset">
                        <i class="acsbi-reset"></i> <span>Reset Settings</span>
                    </a>
                    <a href="accessflow.html#" class="acsb-hero-action" role="button" data-acsb-option="statement">
            ...
            <div class="acsb-search">
                <form class="acsb-form" data-acsb-search="form" enctype="multipart/form-data" action="accessflow.html#"
                    method="POST">
    ...
    <style type="text/css" class="acsb-dynamic-colors">
    ...
    </style><iframe id="intercom-frame" style="
        position: absolute !important;
        opacity: 0 !important;
        width: 1px !important;
        height: 1px !important;
        ...
        z-index: -1 !important;
        pointer-events: none;
      " tabindex="0" title="Intercom" src="./assets/saved_resource.html"></iframe><iframe id="lo-frame-core"
        src="./assets/saved_resource(1).html" aria-hidden="true" title="Lucky Orange: core"
