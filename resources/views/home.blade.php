...
<body class="theme-dashboard" data-new-gr-c-s-check-loaded="14.1064.0" data-gr-ext-installed="">
            ...
            <div class="inner">
                <div class="start">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" data-form="process-form-submission">
                        ...
                        <input type="hidden" name="pageURL" value="/" aria-hidden="true" /><input type="hidden"
        ...
        <div class="wrap">
            <div class="dashboard">
                <section class="hero flex">
                    <div class="bg">
                        <img src="{{ asset('public/site/assets/background.svg') }}" alt="Illustration"
                            role="presentation" />
                    </div>
                    <div class="content" role="main" data-a11y-landmark="content" id="a11y-landmark-content">
                        ...
                        <div class="notification-list">
                            <ul>
                                <li>
                                    <a class="notification danger flex flex-nowrap js-a11y-bound"
                                        href="NOTIFICATION_RECENTLYEXPIRED_LINK" data-clicker-trigger="managebar"
                                        data-manage-accesswidget="629002a7e3cf150011fa4787" role="button">
                                        <div class="message flex flex-nowrap flex-horizontal-start">
                                            <i class="icon icon-warning" aria-hidden="true" role="presentation"><svg
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                ...
                <section class="main flex flex-vertical-start">
                    <div class="start">
                        <div class="dashbox trial">
                            <div class="flex flex-vertical-start">
                                <div class="content">
                                    <h2 class="title title-medium">
                                        Start a 7-day <span class="mark">accessWidget</span> 
                                        trial!
                                    </h2>
                                    <p class="text">
                                        Get started with accessWidget - accessiBe's AI-powered
                                        solution for WCAG and ADA compliance.
                                    </p>
                                    <form data-form="access-widget/add-licenses" action="#" method="post"
                                        ...
                                        <div class="repeater" data-repeater="wrap">
                                            <ul class="fields" data-repeater="items" data-repeater-items="1">
                                                <li class="field js-added" data-repeater="item">
                                                    <input name="domain" aria-label="yourdomain.com"
                                                        placeholder="yourdomain.com" tabindex="0" /><span
                                                        data-repeater="remove"><span class="sr-only">Close</span><i
                                                            class="icon icon-close" aria-hidden="true"
                                        ...
                                        <button class="button button-full" type="submit">
                                            ...
                                            <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                                <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1"
                                                    ...
                                                    xml:space="preserve">
                                                    <path d="M1.5,0L0,1.5L6.5,8L0,14.5L1.5,16l8-8L1.5,0z"></path>
                                                </svg></i></button><span class="note">Start free - no credit card
                                            required!</span>
                                    </form>
                                </div>
                                <div class="media">
                                    <img src="{{ asset('public/site/assets/widget.svg') }}" role="presentation"
                                        alt="Illustration" />
                                </div>
                            </div>
                        </div>
                        <div class="dashbox services capsule">
                            <div class="heading flex">
                                <div class="contents">
                                    <h2 class="title title-medium">
                                        Additional <span class="mark">services</span>  you may
                                        need
                                    </h2>
                                    <p class="text">
                                ...
                                <div class="media">
                                    <img src="{{ asset('public/site/assets/services.png') }}" alt="Illustration"
                                        role="presentation" />
                                </div>
                            </div>
                    ...
                    <div class="end flex flex-horizontal-end">
                        <div class="news">
                            <h2 class="title title-small">News &amp; Updates</h2>
                            <ul>
                                <li>
                                    <a class="item js-a11y-bound"
                                        href="/blog/news/accessibe-brings-web-accessibility-to-national-tv"
                                        target="_blank" data-a11y-tooltip="New Window">
                                        <div class="image">
                                            <img src="{{ asset('public/site/assets/unstoppables.jpg') }}"
                                                role="presentation"
                                        ...
                                        <span class="headline">{{ Utility::getsettings('app_name') }} Brings Web Accessibility to National
                                            ...
                                            <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                                <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1"
                                                    ...
                                                    xml:space="preserve">
                                                    <path d="M1.5,0L0,1.5L6.5,8L0,14.5L1.5,16l8-8L1.5,0z"></path>
                                                </svg></i></span><span class="sr-only">New Window</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="item js-a11y-bound" href="/blog/news/accessibe-opens-offices-in-new-york"
                                        target="_blank" data-a11y-tooltip="New Window">
                                        <div class="image">
                                ...
                                <li>
                                    <a class="item js-a11y-bound" href="/blog/news/accessibe-acquires-routier"
                                        target="_blank" data-a11y-tooltip="New Window">
                                        <div class="image">
    ...
    <footer class="footer" role="contentinfo" aria-label="Footer" data-a11y-landmark="footer" id="a11y-landmark-footer">
        <div class="wrap flex">
            <div class="start">© 2022 - {{ Utility::getsettings('app_name') }} Inc. All Rights Reserved.</div>
            <div class="end">
                <nav class="menu js-a11y-bound" aria-label="Footer menu">
                    <ul class="flex">
                        <li>
                            <a href="/terms-of-service" target="_blank" class="js-a11y-bound"
                                data-a11y-tooltip="Use ←/→ to navigate">
                                Terms of Service <span class="sr-only">New Window</span></a>
                        </li>
                        <li>
                            <a href="/privacy-policy" target="_blank" class="js-a11y-bound"
                                data-a11y-tooltip="New Window">
                                Privacy Policy <span class="sr-only">New Window</span></a>
                        </li>
                        <li>
                            <a href="/support" target="_blank" class="js-a11y-bound" data-a11y-tooltip="New Window">
    ...
    <div class="popup popup-contact popup-xsmall js-ready" data-clicker-element="popup-contact"
        ...
        <div class="content">
            ...
            <form action="#" method="POST" enctype="multipart/form-data" data-form="process-form-submission">
                ...
                <input type="hidden" name="pageURL" value="/" aria-hidden="true" /><input type="hidden" name="element"
                    value="contact-form" aria-hidden="true" />
            </form>
    ...
    <iframe id="lo-frame-core" src="{{ asset('public/site/assets/saved_resource.html') }}" aria-hidden="true"
    ...
    <div class="acsb-widget acsb-widget-position-right acsb-ready" style="display: none" tabindex="-1" role="dialog"
        ...
        <div class="acsb-footer acsb-flex acsb-flex-center" data-acsb-footer="true">
            <a rel="noopener" data-acsb-footer-link="true" href="/?utm_medium=link&amp;utm_source=widget"
                target="_blank">
