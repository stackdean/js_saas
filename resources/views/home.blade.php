                ...
                <ul>
                  <li>
                    <a
                      ...
                      href="NOTIFICATION_RECENTLYEXPIRED_LINK"
        ...
        <div class="wrap flex flex-reverse flex-nowrap">
          ...
          >
            <ul>
              ...
              <li>
                <a class="" href="accessflow" aria-hidden="true" tabindex="-1">
                  accessFlow
                </a>
              </li>
              <li>
            ...
            <ul>
              <li>
                <a class="" href="account.html"> Account &amp; Team </a>
              </li>
              <li>
                <a class="" href="billing.html"> Billing &amp; Payments </a>
              </li>
              <li>
                <a class="" href="audits.html"> Accessibility Audits </a>
              </li>
              <li>
                <a class="" href="partners.html"> Partner Portal </a>
              </li>
              <li>
      ...
      <div class="wrap">
        <div class="dashboard">
          <section class="hero flex">
            <div class="bg">
              <img
                src="{{ asset('public/site/assets/background.svg') }}"
                alt="Illustration"
                role="presentation"
              />
            </div>
            ...
            >
              <h1 class="title title-huge">Welcome, muz!</h1>
              <div class="notification-list">
                <ul>
                  <li>
                    <a
              ...
              <div class="dashbox trial">
                <div class="flex flex-vertical-start">
                  <div class="content">
                    ...
                    <form
                      data-form="access-widget/add-licenses"
                      action="#"
                      method="post"
                      enctype="multipart/form-data"
                    >
                      <div class="repeater" data-repeater="wrap">
                        <ul
                          class="fields"
                          data-repeater="items"
                          data-repeater-items="1"
                        >
                          <li class="field js-added" data-repeater="item">
                            <input
                              name="domain"
                              aria-label="yourdomain.com"
                              placeholder="yourdomain.com"
                              tabindex="0"
                            /><span data-repeater="remove"
                              ><span class="sr-only">Close</span
                              ><i
                      ...
                      <button class="button button-full" type="submit">
                        ...
                        ></i></button
                      ><span class="note"
                        >Start free - no credit card required!</span
                      >
                    </form>
                  </div>
                  <div class="media">
                    <img
                      src="{{ asset('public/site/assets/widget.svg') }}"
                      role="presentation"
                      alt="Illustration"
                    />
                  </div>
              ...
              <div class="dashbox services capsule">
                <div class="heading flex">
                  <div class="contents">
                    ...
                    <p class="text">
                      accessiBe provides a full suite of services to ensure that
                      all of your digital assets are always accessible.
                    </p>
                  </div>
                  <div class="media">
                    <img
                      src="{{ asset('public/site/assets/services.png') }}"
                      alt="Illustration"
                      role="presentation"
                    />
                  </div>
                ...
                <ul class="list flex flex-vertical-start">
                  <li class="service item">
                    <h3 class="name flex flex-nowrap flex-horizontal-start">
                      <img
                        src="{{ asset('public/site/assets/media-service.svg') }}"
                        alt="Icon"
                        role="presentation"
                      />
                      Media Accessibility
                    ...
                    <p class="text text-medium">
                      Media accessibility services for all video and audio
                      assets.
                    </p>
                  </li>
                  <li class="service item">
                    <h3 class="name flex flex-nowrap flex-horizontal-start">
                      <img
                        src="{{ asset('public/site/assets/files-service.svg') }}"
                        alt="Icon"
                        role="presentation"
                      />
                      File Accessibility
                    ...
                    <p class="text text-medium">
                      Document accessibility services for PDF, Powerpoint,
                      Excel, and more.
                    </p>
                  </li>
                  <li class="service item">
                    <h3 class="name flex flex-nowrap flex-horizontal-start">
                      <img
                        src="{{ asset('public/site/assets/consulting-service.svg') }}"
                        alt="Icon"
                        role="presentation"
                      />
                      Expert Auditing
                    ...
                    <p class="text text-medium">
                      Manual audit of your site's source code to discover
                      accessibility gaps.
                    </p>
                  </li>
                  <li class="service item">
                    ...
                    <p class="text text-medium">
                      Evaluate how accessible your project is according to
                  ...
                  <li class="service item">
                    ...
                    <p class="text text-medium">
                      Usability testing by users with disabilities to ensure a
                      seamless experience.
                    </p>
                  </li>
                  <li class="service item">
                    ...
                    <p class="text text-medium">
                      Inspect your access widget installation to ensure maximum
                      performance.
                    </p>
                  </li>
                </ul>
                <div class="cta">
                  <a href="accessservices" class="button">
                    Start a Project
                    <i
                      class="icon icon-chevron-right"
                      aria-hidden="true"
            ...
            <div class="end flex flex-horizontal-end">
              <div class="news">
                ...
                <ul>
                  <li>
                    <a
                      class="item js-a11y-bound"
                      href="/blog/news/accessibe-brings-web-accessibility-to-national-tv"
                      target="_blank"
                      data-a11y-tooltip="New Window"
                      ><div class="image">
                        <img
                          src="{{ asset('public/site/assets/unstoppables.jpg') }}"
                          role="presentation"
                          alt="accessiBe Brings Web Accessibility to National TV"
                        />
                      </div>
                      <span class="headline"
                        >accessiBe Brings Web Accessibility to National TV</span
                      ><span class="text-button text-button-medium">
                        Read more
                        <i
                          class="icon icon-chevron-right"
                          aria-hidden="true"
                  ...
                  <li>
                    <a
                      class="item js-a11y-bound"
                      href="/blog/news/accessibe-opens-offices-in-new-york"
                      target="_blank"
                      data-a11y-tooltip="New Window"
                      ><div class="image">
                        <img
                          src="{{ asset('public/site/assets/newyork.jpg') }}"
                          role="presentation"
                          alt="accessiBe opens new headquarters in New York City with plans to more than double in size"
                        />
                      </div>
                      <span class="headline"
                        >accessiBe opens new headquarters in New York City with
                        plans to more than double in size</span
                      ><span class="text-button text-button-medium">
                        Read more
                        <i
                          class="icon icon-chevron-right"
                  ...
                  <li>
                    <a
                      class="item js-a11y-bound"
                      href="/blog/news/accessibe-acquires-routier"
                      target="_blank"
                      data-a11y-tooltip="New Window"
                      ><div class="image">
                        <img
                          src="{{ asset('public/site/assets/routier.jpg') }}"
                          role="presentation"
                          alt="accessiBe acquires leading service company and platform Routier"
                        />
                      </div>
                      <span class="headline"
                        >accessiBe acquires leading service company and platform
                        Routier</span
                      ><span class="text-button text-button-medium">
                        Read more
                        <i
    ...
    >
      ...
      >
        <a
          ...
          href="/?utm_medium=link&amp;utm_source=widget"
          target="_blank"
        >
