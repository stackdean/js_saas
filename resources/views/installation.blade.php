          ...
          <div class="installation">
            <div class="section">
              <div class="section-header flex flex-nowrap">
                <div
                  class="heading flex flex-inline flex-horizontal-start"
                  role="main"
                  data-a11y-landmark="content"
                  id="a11y-landmark-content"
                >
                  <img
                    src="{{ asset('public/site/assets/codelines.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
                ...
                <div class="buttons flex flex-inline flex-horizontal-end">
                  <div class="cta">
                    <a
                      class="button button-small button-transparent js-a11y-bound"
                      href="https://accessibe.com/support/installation"
                      target="_blank"
                  ...
                  <div class="start">
                    ...
                    >
                      ...
                      <div class="actions flex">
                        ...
                        <div
                          class="action js-a11y-bound"
                          data-clicker-close="code-standard-compressed"
                          data-clicker-trigger="code-standard-uncompressed"
                          role="button"
                          tabindex="0"
                        >
                          <i
                            ...
                            >
                              ...
                              <path d="M0 16h5.5l-5.5-5.5z"></path></svg
                          ></i>
                          Uncompressed Script
                        </div>
                        <div
                    ...
                    <div
                      data-clicker-element="code-standard-uncompressed"
                      class="code-block code-uncompressed"
                      data-code-block=""
                    >
                      <pre
                        class="js-active code language-javascript"
...
<span class="xml"><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></span></code></pre>
                      <div class="actions flex">
                        ...
                        <div
                          ...
                          data-clicker-trigger="code-standard-compressed"
                          role="button"
                          aria-hidden="true"
                        >
                          <i
                  ...
                  <div class="preview">
                    <div class="preview-triggers flex">
                      <div
                        class="preview-trigger js-active js-a11y-bound"
                        data-clicker-trigger="preview-standard-desktop"
                        data-clicker-close="preview-standard-mobile"
                        role="button"
                        tabindex="0"
                      >
                        DESKTOP
                      ...
                      <div
                        class="preview-trigger js-a11y-bound"
                        data-clicker-trigger="preview-standard-mobile"
                        data-clicker-close="preview-standard-desktop"
                        role="button"
                        tabindex="0"
                      >
                        MOBILE
                    ...
                    <div class="preview-box">
                      <span
                        data-clicker-element="preview-standard-desktop"
                        class="preview-icon js-active"
                        ><svg
                          version="1.1"
                          xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        >
                          ...
                          ></circle></svg></span
                      ><span
                        data-clicker-element="preview-standard-mobile"
                        class="preview-icon preview-icon-mobile"
                        ><svg
                          version="1.1"
                          xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        >
                          <path
                            d="M71.6,131.3c1,0,2.1-0.3,3.1-0.8c3.9-1.8,5.5-6.2,3.6-10.1c0,0-14.3-32.7-16.9-44.7c-1-4.2-1.6-15.3-1.8-20.5 c0-1.8,1-3.4,2.6-3.9l32-9.6c3.9-1,6.2-5.5,5.2-9.4c-1-3.9-5.5-6.2-9.4-5.2c0,0-29.6,9.6-40.3,9.6c-10.4,0-39.8-9.4-39.8-9.4 c-3.9-1-8.3,0.8-9.6,4.7c-1.3,4.2,1,8.6,5.2,9.6l32,9.6c1.6,0.5,2.9,2.1,2.6,3.9c-0.3,5.2-0.8,16.4-1.8,20.5 c-2.6,12-16.9,44.7-16.9,44.7c-1.8,3.9,0,8.3,3.6,10.1c1,0.5,2.1,0.8,3.1,0.8c2.9,0,5.7-1.6,6.8-4.4l15.3-31.2l14.6,31.4 C66.1,129.7,68.7,131.3,71.6,131.3z"
                          ></path>
                          <circle cx="50.3" cy="14.6" r="14.6"></circle></svg
                      ></span>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div class="script-builder">
                        <div role="group" class="fields flex">
                          ...
                          <div class="field">
                            <label for="2jej9">Interface Lead Color</label
                            ><input
                              type="color"
                              name="leadColor"
                              value="#146ff8"
                          ...
                          <div class="field">
                            <label for="mw715j"
                              >Accessibility Statement Link</label
                            ><input
                              name="statementLink"
                              type="url"
                          ...
                          <div class="field">
                            <label for="370a6">Interface Footer Content</label
                            ><input
                              name="footerHtml"
                              type="text"
                              placeholder="Leave blank for default"
                          ...
                          <div class="field">
                            <label for="pnelc">Interface Language</label
                            ><select name="language" id="pnelc" tabindex="0">
                          ...
                          <div class="field">
                            <label for="sfvoy">Interface Position</label
                            ><select name="position" id="sfvoy" tabindex="0">
                        ...
                        <div role="group" class="fields flex">
                          ...
                          <div class="field">
                            <label for="03een">Trigger Button Color</label
                            ><input
                              type="color"
                              name="triggerColor"
                              value="#146ff8"
                          ...
                          <div class="field">
                            <label for="4syyw"
                              >Trigger Horizontal Position</label
                            ><select
                          ...
                          <div class="field">
                            <label for="z1tm7">Trigger Vertical Position</label
                            ><select
                          ...
                          <div class="field">
                            <label for="zp12i">Trigger Button Size</label
                            ><select name="triggerSize" id="zp12i" tabindex="0">
                          ...
                          <div class="field">
                            <label for="hlbzif">Trigger Button Shape</label
                            ><select
                              name="triggerRadius"
                              id="hlbzif"
                              tabindex="0"
                          ...
                          <div class="field">
                            <label for="d0b9h">Hide Trigger Button</label
                            ><select name="hideTrigger" id="d0b9h" tabindex="0">
                              <option value="false" selected="">Show</option>
                              <option value="true">Hide</option>
                            </select>
                          </div>
                          <div class="field">
                            <label for="ua40tf">Trigger Horizontal Offset</label
                            ><input
                              type="number"
                              name="triggerOffsetX"
                              value="20"
                          ...
                          <div class="field">
                            <label for="3f2iej">Trigger Vertical Offset</label
                            ><input
                              type="number"
                              name="triggerOffsetY"
                              value="20"
                            ...
                            <ul class="flex">
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon display2"
                                  id="icon-display2"
                                  value="display2"
                                  tabindex="0"
                                /><label for="icon-display2"
                                  ><svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon display3"
                                  id="icon-display3"
                                  value="display3"
                                  tabindex="0"
                                /><label for="icon-display3"
                                  ><svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon people2"
                                  id="icon-people2"
                                  value="people2"
                                  tabindex="0"
                                /><label for="icon-people2"
                                  ><svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon settings2"
                                  id="icon-settings2"
                                  value="settings2"
                                  tabindex="0"
                                /><label for="icon-settings2"
                                  ><svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon wheels"
                                  id="icon-wheels"
                                  value="wheels"
                                  tabindex="0"
                                /><label for="icon-wheels"
                                  ><svg
                                    version="1.1"
                              ...
                              <li>
                                <input
                                  name="triggerIcon"
                                  type="radio"
                                  aria-label="icon wheels2"
                                  id="icon-wheels2"
                                  value="wheels2"
                                  tabindex="0"
                                /><label for="icon-wheels2"
                                  ><svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <div role="group" class="fields flex">
                          ...
                          <div class="field">
                            <label for="3jali">Show On Mobile?</label
                            ><select name="hideMobile" id="3jali" tabindex="0">
                              <option value="false" selected="">Show</option>
                              <option value="true">Hide</option>
                            </select>
                          </div>
                          <div class="field">
                            <label for="6aozff"
                              >Mobile Trigger Horizontal Position</label
                            ><select
                              name="mobileTriggerPositionX"
                              id="6aozff"
                              tabindex="0"
                            >
                              <option value="left">Left</option>
                          ...
                          <div class="field">
                            <label for="ew0ee"
                              >Mobile Trigger Vertical Position</label
                            ><select
                              name="mobileTriggerPositionY"
                              id="ew0ee"
                              tabindex="0"
                            >
                              <option value="top">Top</option>
                          ...
                          <div class="field">
                            <label for="8pw17">Mobile Trigger Size</label
                            ><select
                              name="mobileTriggerSize"
                              id="8pw17"
                              tabindex="0"
                            >
                          ...
                          <div class="field">
                            <label for="onlp4">Trigger Mobile Shape</label
                            ><select
                              name="mobileTriggerRadius"
                              id="onlp4"
                              tabindex="0"
                            >
                              <option value="50%" selected="">Round</option>
                          ...
                          <div class="field">
                            <label for="ly7em"
                              >Mobile Trigger Horizontal Offset</label
                            ><input
                              type="number"
                              name="mobileTriggerOffsetX"
                              value="10"
                              id="ly7em"
                              tabindex="0"
                            />
                          ...
                          <div class="field">
                            <label for="silpd"
                              >Mobile Trigger Vertical Offset</label
                            ><input
                              type="number"
                              name="mobileTriggerOffsetY"
                              value="0"
                              id="silpd"
                              tabindex="0"
                            />
                      ...
                      <button type="submit" class="button">
                        ...
                        <i
                          ...
                          ><svg
                            ...
                            y="0px"
                            viewBox="0 0 16 9.5"
                            style="enable-background: new 0 0 16 9.5"
                            xml:space="preserve"
                          >
                            <path
                              d="M16,1.5L14.5,0L8,6.5L1.5,0L0,1.5l8,8L16,1.5z"
                            ></path></svg
                        ></i>
                      </button>
                      <div
                      ...
                      >
                        <div
                          data-clicker-element="code-custom-compressed"
                          class="js-active code-block code-compressed"
                          data-code-block=""
                        >
                          <pre
                            class="js-active code language-javascript"
                          ...
                          <div class="actions flex">
                            ...
                            <div
                              ...
                              data-clicker-trigger="code-custom-uncompressed"
                              role="button"
                              aria-hidden="true"
                            >
                              <i
                        ...
                        <div
                          data-clicker-element="code-custom-uncompressed"
                          class="code-block code-uncompressed"
                          data-code-block=""
                        >
                          <pre
                          ...
                          <div class="actions flex">
                            ...
                            <div
                              ...
                              data-clicker-trigger="code-custom-compressed"
                              role="button"
                              aria-hidden="true"
                            >
                              <i
                  ...
                  <div class="preview">
                    <div class="preview-triggers flex">
                      <div
                        ...
                        data-clicker-close="preview-custom-mobile"
                        role="button"
                        tabindex="0"
                      >
                        DESKTOP
                      ...
                      <div
                        ...
                        data-clicker-close="preview-custom-desktop"
                        role="button"
                        tabindex="0"
                      >
                        MOBILE
                    ...
                    <div
                      class="preview-box preview-box-interface"
                    ...
                    >
                      ...
                      >
                        ...
                        ></path>
                        <path
                          d="M41.0571 400.045L43.1626 402.15L45.2681 400.045"
                          stroke="white"
                          stroke-width="1.05275"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        ></path>
                        <path
                          d="M149.49 401.624L147.385 399.519L145.279 401.624"
                          stroke="white"
                          stroke-width="1.05275"
                          stroke-linecap="round"
                          stroke-linejoin="round"
        ...
        <div
          class="popup popup-install-instructions popup-xsmall js-ready"
          data-clicker-element="popup-install-instructions"
          data-clicker-lock-body="true"
        >
          <div
            class="wide-close js-a11y-bound"
            data-clicker-close="popup-install-instructions"
            role="button"
            aria-hidden="true"
          ></div>
          <div class="content">
              ...
              <div class="fields">
                <div class="field">
                  <label for="developerEmail">
                    Developer Email <span class="req">*</span></label
                  ><input
                    id="developerEmail"
                    name="developerEmail"
                    aria-required="true"
    ...
    ><iframe
      id="lo-frame-core"
      src="{{ asset('public/site/assets/saved_resource.html')}}"
      aria-hidden="true"
    ...
    ><iframe
      ...
      tabindex="-1"
      title="Intercom"
      src="{{ asset('public/site/assets/saved_resource(1).html')}}"
    ></iframe>
  </body>
