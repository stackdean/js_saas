          ...
          <div class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                ...
                >
                  <img
                    src="{{ asset('public/site/assets/ccard.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
                ...
                <div class="buttons flex flex-inline flex-horizontal-end">
                  <div class="cta">
                    <a
                      ...
                      href="{{url('billing')}}#popup-billing"
                      role="button"
                    >
                      Add Billing Method
                      <i
            ...
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                <div class="heading flex flex-inline flex-horizontal-start">
                  <img
                    src="{{ asset('public/site/assets/payments.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
