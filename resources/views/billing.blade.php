...
<head>
    ...
    <title>@yield('title', __('Billing')) | {{ Utility::getsettings('app_name') }}</title>
...
<body class="theme-billing" data-new-gr-c-s-check-loaded="14.1064.0" data-gr-ext-installed="">
    <div class="a11y-skip-links js-a11y-bound" aria-label="Skip links" role="region">
        <a class="a11y-skip-link js-a11y-bound" href="billing.html#a11y-landmark-content"
            data-a11y-skip-link="content">Skip to content<span aria-hidden="true"></span></a><a
            class="a11y-skip-link js-a11y-bound" href="billing.html#a11y-landmark-menu" data-a11y-skip-link="menu">Skip
            to menu<span aria-hidden="true"></span></a><a class="a11y-skip-link js-a11y-bound"
            href="billing.html#a11y-landmark-footer" data-a11y-skip-link="footer">Skip to footer<span
                ...
                <nav class="menu flex flex-nowrap js-a11y-bound" aria-label="Main menu" data-a11y-landmark="menu"
                  ...
                  >
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="active" href="{{url('billing')}}"> Billing &amp; Payments </a>
                        </li>
                        <li>
        ...
        <div class="content">
            <div class="inner">
                <div class="start">
                    ...
                    <form action="billing.html#" method="POST" enctype="multipart/form-data"
                        ...
                        <input type="hidden" name="pageURL" value="/billing" aria-hidden="true" /><input type="hidden"
                    ...
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start" role="main"
                                ...
                                <img src="{{ asset('public/site/assets/ccard.svg')}}" alt="Icon" role="presentation" />
                    ...
                    <div class="inner">
                        <div class="section-header flex flex-nowrap">
                            <div class="heading flex flex-inline flex-horizontal-start">
                                <img src="{{ asset('public/site/assets/payments.svg')}}" alt="Icon"
                                    role="presentation" />
                                <h2 class="title title-medium2">Your payment history</h2>
                            </div>
                        </div>
        ...
        <div class="acsb-main" data-acsb="main">
            <div class="acsb-header acsb-flex">
                <div class="acsb-start">
                    <a href="billing.html#" role="button" tabindex="-1"
                ...
                <a role="button" href="billing.html#" tabindex="-1" aria-label="English"
            ...
            <div class="acsb-hero">
                ...
                <div class="acsb-hero-actions acsb-flex">
                    <a href="billing.html#" class="acsb-hero-action" role="button" tabindex="-1"
                        data-acsb-option="reset">
                        <i class="acsbi-reset"></i> <span>Reset Settings</span>
                    </a>
                    <a href="billing.html#" class="acsb-hero-action" role="button" data-acsb-option="statement"
                        tabindex="-1">
            ...
            <div class="acsb-search">
                <form class="acsb-form" data-acsb-search="form" enctype="multipart/form-data" action="billing.html#"
                    method="POST">
    ...
    <style type="text/css" class="acsb-dynamic-colors">
      ...
      " aria-hidden="true" tabindex="-1" title="Intercom"
        src="{{ asset('public/site/assets/saved_resource.html')}}"></iframe><iframe id="lo-frame-core"
        src="{{ asset('public/site/assets/saved_resource(1).html')}}" aria-hidden="true" title="Lucky Orange: core"
    ...
    <div id="intercom-container" class="intercom-namespace">
        <style>
            ...
            html.intercom-mobile-messenger-active.intercom-mobile-messenger-ios-15>body {
