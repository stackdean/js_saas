    ...
    <header class="header">
        ...
        <div class="wrap flex flex-nowrap">
          <div class="start flex flex-inline flex-nowrap">
            ...
            <nav class="menu">
              <ul>
                <li>
                  <a class="" href="accesswidget.html"
                    ><i class="icon icon-access-widget"
                      ><svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                ...
                <li>
                  <a class="" href="accessservices.html"
                    ><i class="icon icon-access-services"
                      ><svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                ...
                <li>
                  <a class="" href="accesscampus.html"
                    ><i class="icon icon-access-campus"
                      ><svg
                        width="27"
                        height="20"
                        viewBox="0 0 27 20"
          ...
          >
            ...
            ><a
              class="action button button-small button-gray"
              href="#popup-demo"
            >
              Contact Sales </a
            ><button
            ...
            >
              <div class="notification-list">
                <ul>
                  <li>
                    <a
                      class="notification danger flex flex-nowrap"
      ...
      <div class="bottom">
        <div class="wrap flex flex-reverse flex-nowrap">
          ...
          <nav class="menu flex flex-nowrap">
            <ul>
              <li>
                <a class="" href="accesswidget.html"> accessWidget </a>
              </li>
              <li>
                <a class="" href="accessflow.html"> accessFlow </a>
              </li>
              <li>
                <a class="" href="accessservices.html"> accessServices </a>
              </li>
              <li>
                <a class="" href="accesscampus.html">
                  accessCampus <span class="flag">SOON</span></a
