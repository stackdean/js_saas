...
<head>
    ...
    <meta name="description" content="accessWidget" />
    <link href="https://dashboard.accessibe.com/media/template/favicon.ico" type="image/x-icon" rel="shortcut icon" />
    <title>@yield('title', __('ًAccess Widget')) | {{ Utility::getsettings('app_name') }}</title>
...
<body class="theme-accesswidget" data-new-gr-c-s-check-loaded="14.1064.0" data-gr-ext-installed="">
            ...
            <div class="wrap flex flex-nowrap">
                <div class="start flex flex-inline flex-nowrap">
                    ...
                    <nav class="menu js-a11y-bound" aria-label="Main menu" data-a11y-landmark="menu"
                        ...
                        <ul>
                            <li>
                                <a class="active" href="{{url('widget')}}" data-a11y-tooltip="Use ←/→ to navigate"><i
        ...
        <div class="bottom">
            <div class="wrap flex flex-reverse flex-nowrap">
                ...
                <nav class="menu flex flex-nowrap js-a11y-bound" aria-label="Main menu" data-a11y-landmark="menu"
                    ...
                    <ul>
                        <li>
                            <a class="active" href="{{url('widget')}}" data-a11y-tooltip="Use ←/→ to navigate"
                                aria-hidden="true" tabindex="-1">
                                accessWidget
                            </a>
                        </li>
            ...
            <div class="inner">
                <div class="start">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" data-form="process-form-submission">
                        ...
                        <input type="hidden" name="pageURL" value="/accesswidget" aria-hidden="true" /><input
    ...
    <main class="chief" role="none">
        <div class="wrap">
            <div class="hero flex">
                <div class="start" role="main" data-a11y-landmark="content" id="a11y-landmark-content">
                    <h1 class="title title-big">
                        <span class="mark">Automatic</span>  Web Accessibility, <br />ADA,
                        &amp; WCAG <span class="mark">Compliance</span> 
                    </h1>
                    <p class="text">
                        Automatically achieve web accessibility, WCAG, and ADA compliance
                        with accessWidget's leading AI technology.
                    </p>
                    <a class="text-button js-a11y-bound" href="https://accessibe.com/product" target="_blank"
                        data-a11y-tooltip="New Window">
                        More about accessWidget
                        <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                            <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                ...
                <div class="end">
                    <img class="object-cover" src="./assets/widget-hero.png" alt="illustration" role="presentation"
                        aria-hidden="true" />
                </div>
            </div>
            <div class="page">
                <div class="section">
                    <div class="section-header flex flex-nowrap">
                        <div class="heading flex flex-inline flex-horizontal-start">
                            <img src="./assets/managewebsites.svg" alt="Icon" role="presentation" />
                            <h2 class="title title-medium">
                                accessWidget licenses <span class="mark">(1 total)</span> 
                            </h2>
                        </div>
                        <div class="buttons flex flex-inline flex-horizontal-end">
                            <div class="cta">
                                <a class="button button-small button-icon-flip button-transparent js-a11y-bound"
                                    href="#popup-batches" role="button"><i class="icon icon-lightning"
                                        aria-hidden="true" role="presentation"><svg version="1.1"
                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 12 18"
                                            style="enable-background: new 0 0 12 18" xml:space="preserve">
                                            <path d="M9,0L0,10.1h5.5L3,18l9-10.1H6.5L9,0z"></path>
                                        </svg></i>
                                    Batch Management
                                </a>
                            </div>
                            <div class="cta">
                                <a class="button button-small button-icon-flip js-a11y-bound" href="#popup-add-licenses"
                                    role="button"><i class="icon icon-plus" aria-hidden="true" role="presentation"><svg
                                            version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                            viewBox="0 0 12.3 12.3" style="enable-background: new 0 0 12.3 12.3"
                                            xml:space="preserve">
                                            <path d="M12.3,5.1v2.1H7.2v5.1H5.1V7.2H0V5.1h5.1V0h2.2v5.1H12.3z"></path>
                                        </svg></i>
                                    Add New Websites
                                </a>
                            </div>
                    ...
                    <table class="licenses-table js-a11y-bound" data-accesswidget-table="">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Domain</th>
                        ...
                        <tbody>
                            <tr data-manage-accesswidget="629002a7e3cf150011fa4787" tabindex="0"
                                data-clicker-trigger="managebar" class="js-a11y-bound" role="button">
                                <td></td>
                                <td>
                                    <div class="semibold">whatshungry.com</div>
                                </td>
                                <td>0 days</td>
                                <td><span class="ribbon ribbon-red"> EXPIRED </span></td>
                                <td>-</td>
                                <td>
                                    <span class="text-button text-button-nocolor">
                                        Manage
                                        <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                            <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="popup popup-batches js-ready" data-clicker-element="popup-batches"
                data-clicker-lock-body="true">
                <div class="wide-close js-a11y-bound" data-clicker-close="popup-batches" role="button"
                    aria-hidden="true"></div>
                <div class="content">
                    <div class="close js-a11y-bound" role="button" aria-label="Close" data-clicker-close="popup-batches"
                        aria-hidden="true">
                        <span class="sr-only">Close</span><i class="icon icon-close" aria-hidden="true"
                            role="presentation"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16">
                    ...
                    <h4 class="title title-big">
                        Choose a <span class="mark">batch</span>  operation
                    </h4>
                    <ul class="flex flex-vertical-stretch flex-nowrap">
                        <li>
                            <button data-batches-load="CSV" aria-hidden="true" tabindex="-1">
                                <i class="icon icon-csv" aria-hidden="true" role="presentation"><svg width="48"
                                        height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M36 46H15.875C13.942 46 12.375 44.433 12.375 42.5V14.5C12.375 12.567 13.942 11 15.875 11H31.8146L36 11C37.933 11 39.5 12.567 39.5 14.5V18V42.5C39.5 44.433 37.933 46 36 46ZM15.2419 27.5312H15.9919H21.4169H22.1669V28.2812V31.0312H35.8836H36.6336V31.7812V42.2812V43.0312H35.8836H22.1669H21.4169H15.9919H15.2419V42.2812V31.7812V31.0312V28.2812V27.5312ZM20.6669 29.0312V31.0312H16.7419V29.0312H20.6669ZM16.7419 34.5312V32.5312H20.6669V34.5312H16.7419ZM16.7419 36.0312V38.0312H20.6669V36.0312H16.7419ZM16.7419 41.5312V39.5312H20.6669V41.5312H16.7419ZM22.1669 41.5312V39.5312H35.1336V41.5312H22.1669ZM35.1336 36.0312V38.0312H22.1669V36.0312H35.1336ZM35.1336 34.5312V32.5312H22.1669V34.5312H35.1336Z"
                                            fill="#2C3242"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M28.125 11.0625C28.125 16.6199 23.6199 21.125 18.0625 21.125C12.5051 21.125 8 16.6199 8 11.0625C8 5.50513 12.5051 1 18.0625 1C23.6199 1 28.125 5.50513 28.125 11.0625ZM18.8132 6.81098L20.8867 8.88449C21.1796 9.17738 21.6544 9.17738 21.9473 8.88449C22.2402 8.5916 22.2402 8.11672 21.9473 7.82383L18.5932 4.46966L18.0628 3.93933L17.5325 4.46966L14.1783 7.82383C13.8854 8.11672 13.8854 8.5916 14.1783 8.88449C14.4712 9.17738 14.9461 9.17738 15.239 8.88449L17.3128 6.81065V11.6215C17.3128 11.629 17.3129 11.6364 17.3132 11.6439V14.8109L15.2393 12.737C14.9464 12.4441 14.4715 12.4441 14.1787 12.737C13.8858 13.0299 13.8858 13.5048 14.1787 13.7977L17.5328 17.1519L18.0632 17.6822L18.5935 17.1519L21.9476 13.7977C22.2405 13.5048 22.2405 13.0299 21.9476 12.737C21.6548 12.4441 21.1799 12.4441 20.887 12.737L18.8132 14.8109V6.81098Z"
                                            fill="#60D0FF"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M18.0625 21.125C23.6199 21.125 28.125 16.6199 28.125 11.0625C28.125 11.0416 28.1249 11.0208 28.1248 11H18.8132V14.8109L20.887 12.737C21.1799 12.4441 21.6548 12.4441 21.9476 12.737C22.2405 13.0299 22.2405 13.5048 21.9476 13.7977L18.5935 17.1519L18.0632 17.6822L17.5328 17.1519L14.1787 13.7977C13.8858 13.5048 13.8858 13.0299 14.1787 12.737C14.4715 12.4441 14.9464 12.4441 15.2393 12.737L17.3132 14.8109V14.6439C17.3129 14.6364 17.3128 14.629 17.3128 14.6215L17.3128 11H15.875C13.942 11 12.375 12.567 12.375 14.5V19.3646C13.9929 20.4752 15.9518 21.125 18.0625 21.125Z"
                                            fill="#136EF8"></path>
                                        <path
                                            d="M18.0632 10V16.6215M18.0632 16.6215L14.709 13.2674M18.0632 16.6215L21.4173 13.2674"
                                            stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
                                        <path
                                            d="M18.0628 11.6215L18.0628 4.99999M18.0628 4.99999L21.417 8.35416M18.0628 4.99999L14.7087 8.35416"
                                            stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
                                    </svg></i>
                                CSV Import/Export
                            </button>
                        ...
                        <li>
                            <button data-batches-load="subscriptions" aria-hidden="true" tabindex="-1">
                                <i class="icon icon-batchsubscription" aria-hidden="true" role="presentation"><svg
                                        width="48" height="48" viewBox="0 0 48 48" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M6.20041 14.5442C5.3367 14.7756 4.82414 15.6634 5.05557 16.5271L9.92721 34.7083C10.1586 35.572 11.0464 36.0846 11.9101 35.8532L39.858 28.3645C40.7217 28.1331 41.2342 27.2453 41.0028 26.3816L37.6175 13.7476L6.5428 22.074L5.59942 18.5533L36.6742 10.2268L36.1312 8.20041C35.8997 7.3367 35.012 6.82414 34.1482 7.05557L6.20041 14.5442Z"
                                            fill="#2C3242"></path>
                                        <rect x="13.0967" y="21.5715" width="30.7619" height="19.4286" rx="1.61905"
                                            fill="#60D0FF"></rect>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M39.7132 21.5715H14.4229C13.6905 21.5715 13.0967 22.1653 13.0967 22.8977V35.535L39.8572 28.3645C40.7209 28.1331 41.2335 27.2453 41.0021 26.3816L39.7132 21.5715Z"
                                            fill="#136EF8"></path>
                                        <circle cx="38.5951" cy="35.7381" r="2.83333" fill="white"></circle>
                                    </svg></i>
                                Batch Plan Payment
                            </button>
                        </li>
                        <li>
                            <button data-batches-load="updates" aria-hidden="true" tabindex="-1">
                                <i class="icon icon-batchupdate" aria-hidden="true" role="presentation"><svg width="48"
                                        height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M17 13C15.3431 13 14 14.3431 14 16V39C14 40.6569 15.3431 42 17 42H41C42.6569 42 44 40.6569 44 39V16C44 14.3431 42.6569 13 41 13H17ZM41 20H17V37C17 38.1046 17.8954 39 19 39H39C40.1046 39 41 38.1046 41 37V20ZM23 23H20V26H23V23ZM20 28H23V31H20V28ZM23 33H20V36H23V33ZM25 23H28V26H25V23ZM28 28H25V31H28V28ZM25 33H28V36H25V33ZM33 23H30V26H33V23ZM30 28H33V31H30V28ZM33 33H30V36H33V33ZM35 23H38V26H35V23ZM38 28H35V31H38V28ZM35 33H38V36H35V33ZM25 16.5C25 17.3284 24.3284 18 23.5 18C22.6716 18 22 17.3284 22 16.5C22 15.6716 22.6716 15 23.5 15C24.3284 15 25 15.6716 25 16.5ZM34.5 18C35.3284 18 36 17.3284 36 16.5C36 15.6716 35.3284 15 34.5 15C33.6716 15 33 15.6716 33 16.5C33 17.3284 33.6716 18 34.5 18Z"
                                            fill="#2C3242"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M14.0625 27.125C19.6199 27.125 24.125 22.6199 24.125 17.0625C24.125 11.5051 19.6199 7 14.0625 7C8.50513 7 4 11.5051 4 17.0625C4 22.6199 8.50513 27.125 14.0625 27.125ZM14.75 12.55C14.75 12.1358 14.4142 11.8 14 11.8C13.5858 11.8 13.25 12.1358 13.25 12.55V17.95C13.25 18.3642 13.5858 18.7 14 18.7H17C17.4142 18.7 17.75 18.3642 17.75 17.95C17.75 17.5358 17.4142 17.2 17 17.2H14.75V12.55Z"
                                            fill="#60D0FF"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M17 26.6898C16.071 26.9728 15.085 27.125 14.0635 27.125C14.0423 27.125 14.0211 27.1249 14 27.1248V18.7C14.0003 18.7 14.0007 18.7 14.001 18.7H17.001C17.4152 18.7 17.751 18.3642 17.751 17.95C17.751 17.5358 17.4152 17.2 17.001 17.2H14.751V14.0145C15.3007 13.3924 16.1045 13 17 13H23.2722C23.561 13.6536 23.7822 14.3438 23.9271 15.0617C23.7917 15.0215 23.6484 15 23.5 15C22.6716 15 22 15.6716 22 16.5C22 17.3284 22.6716 18 23.5 18C23.7108 18 23.9114 17.9565 24.0934 17.878C24.0347 18.6103 23.8976 19.3204 23.6905 20H17V26.6898ZM22.1884 23C21.5758 23.8369 20.837 24.5756 20 25.1881V23H22.1884Z"
                                            fill="#136EF8"></path>
                                        <path d="M14 12.55V17.95H17" stroke="white" stroke-width="1.5"
            ...
            <div class="popup popup-add-licenses popup-small js-ready" data-clicker-element="popup-add-licenses"
                data-clicker-lock-body="true">
                <div class="wide-close js-a11y-bound" data-clicker-close="popup-add-licenses" role="button"
                    aria-hidden="true"></div>
                <div class="content">
                    <div class="close js-a11y-bound" role="button" aria-label="Close"
                        data-clicker-close="popup-add-licenses" aria-hidden="true">
                        <span class="sr-only">Close</span><i class="icon icon-close" aria-hidden="true"
                            role="presentation"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16">
                                <path
                    ...
                    <form data-form="access-widget/add-licenses" action="#" method="post" enctype="multipart/form-data">
                        <div class="popup-heading">
                            <div class="title title-medium">
                                Every website gets a 7-day free trial!
                            </div>
                            <div class="text">
                                You can skip the trial and purchase a license directly in the
                                next step.<br /><br /><strong>Please note:</strong> More
                                fields will show up after typing the first domain, so you can
                                add all your websites at once.
                            </div>
                        </div>
                        <div class="repeater" data-repeater="wrap">
                            <ul class="fields" data-repeater="items" data-repeater-items="1">
                                <li class="field js-added" data-repeater="item">
                                    <input name="domain" aria-label="yourdomain.com" placeholder="yourdomain.com"
                                        aria-hidden="true" /><span data-repeater="remove"><span
                                            class="sr-only">Close</span><i class="icon icon-close" aria-hidden="true"
                                            role="presentation"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="hidden" data-repeater="add">ADD NEW</span>
                        </div>
                        <button class="button button-full" type="submit" aria-hidden="true" tabindex="-1">
                            Start Free Trial
                            <i class="icon icon-chevron-right" aria-hidden="true" role="presentation">
                                <!--?xml version="1.0" encoding="utf-8"?--><svg version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div class="popup popup-contact popup-xsmall js-ready" data-clicker-element="popup-contact"
        ...
        <div class="content">
            ...
            <form action="#" method="POST" enctype="multipart/form-data" data-form="process-form-submission">
                ...
                <input type="hidden" name="pageURL" value="/accesswidget" aria-hidden="true" /><input type="hidden"
    ...
    <button type="button" id="intercom-trigger" aria-label="Online chat" aria-hidden="true" tabindex="-1"
        class="js-active">
    ...
    <div class="acsb-widget acsb-widget-position-right acsb-ready" style="display: none" tabindex="-1" role="dialog"
        ...
        <div class="acsb-main" data-acsb="main">
            <div class="acsb-header acsb-flex">
                <div class="acsb-start">
                    <a href="#" role="button" tabindex="0" class="acsb-header-option acsb-header-option-close"
                        data-acsb-option="close" aria-label="Close Accessibility Interface">
                        <i class="acsbi-close"></i>
                    </a>
                </div>
                <a role="button" href="#" tabindex="0" aria-label="English"
            ...
            <div class="acsb-hero">
                ...
                <div class="acsb-hero-actions acsb-flex">
                    <a href="#" class="acsb-hero-action" role="button" tabindex="0" data-acsb-option="reset">
                        <i class="acsbi-reset"></i> <span>Reset Settings</span>
                    </a>
                    <a href="#" class="acsb-hero-action" role="button" data-acsb-option="statement">
                        <i class="acsbi-bookmark"></i> <span>Statement</span>
                    </a>
                    <a href="#" class="acsb-hero-action" role="button" tabindex="0"
            ...
            <div class="acsb-search">
                ...
                <div class="acsb-search-results-wrapper" data-acsb-search-results="wrapper">
                    <span role="button" tabindex="0" data-acsb-search-results="close" aria-label="Close"
                                ...
                                <div class="acsb-big-box-element acsb-big-box-element-color">
                                    <div class="acsb-color-box">
                                        <span data-acsb-color="#0076B4" class="acsb-color-selection" role="button"
                                            tabindex="0" aria-label="Change Color to Blue"
        ...
        <div class="acsb-popup acsb-language-popup" tabindex="0" data-acsb-popup="acsb-language-popup">
            ...
            <div class="acsb-popup-content" role="dialog">
                <span class="acsb-popup-close" tabindex="0" role="button" aria-label="Close"
                ...
                <div class="acsb-popup-content-holder" data-acsb-popup-content-holder="">
                    <div class="acsb-language-selection">
                        ...
                        <div class="acsb-languages acsb-flex">
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="en">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="es">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="de">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="pt">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="fr">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="it">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="he">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="tw">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="ru">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="ar">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="ua">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="nl">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="zh">
                                <span class="acsb-language-flag">
                                    <span
                            ...
                            <div class="acsb-language" role="button" tabindex="0" data-acsb-language="ja">
                                <span class="acsb-language-flag">
                                    <span
                ...
                <div class="acsb-popup-content-holder" data-acsb-popup-content-holder="">
                    <div class="acsb-hide">
                        ...
                        <div class="acsb-buttons">
                            <span role="button" tabindex="0" class="acsb-button acsb-button-colorized"
                                data-acsb-option="hide">Accept</span>
                            <span role="button" tabindex="0" class="acsb-button"
    ...
    <iframe id="lo-frame-core" src="./assets/saved_resource.html" aria-hidden="true" title="Lucky Orange: core"
