...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Audits" />
    <link
      href="https://dashboard.accessibe.com/media/template/favicon.ico"
      type="image/x-icon"
      rel="shortcut icon"
    />
    <title>@yield('title', __('Audits')) | {{ Utility::getsettings('app_name') }}</title>
  ...
  >
    ...
    <main class="chief" role="none">
      <div class="wrap">
          ...
          <section class="section">
            <div class="inner">
              <div class="section-header flex flex-nowrap">
                ...
                >
                  <img
                    src="{{ asset('public/site/assets/audit.svg')}}"
                    alt="Icon"
                    role="presentation"
                  />
                  <h2 class="title title-medium2">My accessibility audits</h2>
                </div>
              </div>
              <form
                class="audit-form"
              ...
              >
                <div class="button-appended button-appended-medium">
                  <input
                    ...
                    data-ace-url="https://acsbace.com"
              ...
              <div class="section-explainer">
                <p class="text">
                  Here you’ll find a history of all accessibility audits that
                  you have run for your websites. You can download them below.
                </p>
              </div>
              <table class="js-a11y-bound">
                ...
                <tbody>
                  <tr>
                    <td><span class="semibold">waseeya.com</span></td>
                    <td>
                      <div class="ribbon ribbon-orange">Semi Compliant</div>
                    </td>
                    <td></td>
                    <td>May 28, 2022</td>
                    <td>
                      <a
                        class="text-button js-a11y-bound"
                        href="https://acsbace.com/reports/6292ac986b4f1a00297728d9"
                        target="_blank"
        ...
        <div
          class="popup popup-audit js-ready popup-close-bg"
          data-clicker-element="popup-audit"
          data-clicker-lock-body="true"
        >
          <div
            class="wide-close js-a11y-bound"
            data-clicker-close="popup-audit"
            role="button"
            aria-hidden="true"
          ></div>
          <div class="content">
            ...
            <span data-audit="placeholder"></span>
          </div>
        </div>
      </div>
    </main>
